...
class CAM_TFORM_OBJ_SOURCES(StrEnum):
    PCL = "pcl"
    CO3DV1 = "co3dv1"
    CO3D = "co3d"
    LABELED = "labeled"
...
class CO3D_FRAME_TYPES(StrEnum):
    DEV_KNOWN = "dev_known"
...
class CO3D_FRAME_SPLITS(StrEnum):
